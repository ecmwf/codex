...
- To give access, Maintainers and Contributors need to have a GitHub account. Currently for github.com/ecmwf this is a Github Enterprise account, for which the following applies:
   ...
   - External contributions must follow the policy for [External Contributions|https://github.com/ecmwf/codex/tree/main/External%20Contributions]
...
- Ensure a `README` file exists in the root directory
   ...
   - Clarify the state of the software (stable, alpha, beta, obsolete, …) or, preferably, define following Software Maturity guidelines, see <https://github.com/ecmwf/codex/tree/main/Project%20Maturity>
...
- Ensure the relevant software licence is applied
   - One central licence file and references in each (code) file; this
     repository includes a Perl script `licence.pl` that can be adapted to
     insert the header
   - For Apache Licence, see <https://confluence.ecmwf.int/display/SUPINF/Applying+the+Apache+License>
