...
- If any external contributions are expected, add the Contributor Licence Agreement plugin (CLA Assistant) to the repository (see the [Contributor License Agreement](./Contributor-License-Agreement.md)).
