...
* **Mandatory Review:** Code generated by AI Agents is always subject to review, as customary for any code contribution. This should include both automated checks and human peer review. This code review may itself be assisted by AI agents, but the final review and approval must be performed by a human reviewer. 
* **Reviews by AI Agents:** If you are using an AI agent to support code reviews, a good practice is to have a different AI agent model review the code, to provide a form of "cross-checking" and reduce the risk of blind spots or biases in a single model.
