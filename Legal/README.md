...
Legal guidance for ECMWF software projects covering licensing, copyright, and repository governance.

## Contents

- [Copyright and Licensing](./Copyright-And-Licensing.md) — ECMWF's approach to copyright and applying the Apache License
- [SPDX and REUSE](./SPDX-and-REUSE.md) — machine-readable SPDX/REUSE licence headers, recommended going forward (see ADR-010), with copy-ready [templates](./SPDX-REUSE-templates/)
