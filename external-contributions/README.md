...
- Initialise the repository using the ECMWF cookie-cutter template and follow the [Repository Structure](../repository-structure/README.md).  
- Add an appropriate [Project Maturity Badge](../project-maturity/README.md) (e.g., *Sandbox*).
