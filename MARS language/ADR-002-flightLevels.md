...
In ecCharts, Clear-Air-Turbulence (CAT) is provided on a set of different flight levels, and this data should be produced in GRIB2 in 50r1. See an example of CAT on flight levels:
https://charts.ecmwf.int/products/medium-cat?base_time=202601210000&flight_level=9144&projection=opencharts_europe&valid_time=202601210300 
